  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 font-sans transition-colors duration-200 overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#recursos" className="text-sm text-slate-500 dark:text-gray-400 hover:text-emerald-500 transition-colors font-medium">Recursos</a>
              <a href="#como-funciona" className="text-sm text-slate-500 dark:text-gray-400 hover:text-emerald-500 transition-colors font-medium">Como Funciona</a>
              <a href="#precos" className="text-sm text-slate-500 dark:text-gray-400 hover:text-emerald-500 transition-colors font-medium">Preços</a>
              <a href="#faq" className="text-sm text-slate-500 dark:text-gray-400 hover:text-emerald-500 transition-colors font-medium">FAQ</a>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white dark:bg-slate-950 border-b border-gray-100 dark:border-gray-800 px-4 py-4 space-y-2">
            <a href="#recursos" className="block px-3 py-2 rounded-lg text-sm font-medium text-slate-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800">Recursos</a>
            <a href="#como-funciona" className="block px-3 py-2 rounded-lg text-sm font-medium text-slate-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800">Como Funciona</a>
            <a href="#precos" className="block px-3 py-2 rounded-lg text-sm font-medium text-slate-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800">Preços</a>
            <a href="#faq" className="block px-3 py-2 rounded-lg text-sm font-medium text-slate-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800">FAQ</a>
            <div className="flex gap-3 pt-2">
              <Link to="/login" className="flex-1 text-center px-4 py-2.5 border border-gray-200 dark:border-gray-700 text-slate-900 dark:text-white text-sm font-semibold rounded-xl">Entrar</Link>
