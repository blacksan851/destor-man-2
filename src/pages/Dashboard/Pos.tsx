...
export function Pos() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-4rem)] bg-black text-white overflow-hidden relative">
      {/* Mobile Tab Toggle Bar */}
      <div className="lg:hidden flex border-b border-gray-900 bg-black p-2 gap-2 shrink-0">
        <button
      ...
      <div className={`flex-1 flex flex-col p-4 sm:p-6 overflow-hidden border-r border-gray-900 bg-black ${
        ...
        <div className="flex gap-2 mb-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-gray-900 border border-gray-800 rounded-2xl outline-none text-white text-sm shadow-sm focus:ring-2 focus:ring-emerald-500 placeholder:text-gray-500"
            />
            {searchQuery && (
              <button 
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-4 bg-gray-950 rounded-2xl border transition-all flex flex-col justify-between select-none ${
                      isOut 
                        ? 'opacity-40 border-gray-900 cursor-not-allowed' 
                        : 'hover:border-emerald-500/50 border-gray-900 cursor-pointer'
                    }`}
                  >
                    <div>
                      {product.image_url && (
      ...
      <div className={`w-full lg:w-[420px] bg-black flex flex-col h-full shadow-2xl border-l border-gray-900 ${
        ...
        <div className="p-4 border-b border-gray-900 space-y-3">
          ...
          <div className="flex items-center gap-2 bg-gray-900 p-2.5 rounded-xl border border-gray-800">
            ...
            >
              <option value="balcao" className="bg-black text-white">Cliente Balcão (Avulso)</option>
              {registeredCustomers.map((cust) => (
                <option key={cust.id} value={cust.id} className="bg-black text-white">
          ...
          {selectedCustomerId === 'balcao' && (
            <input
              ...
              className="w-full px-3 py-1.5 bg-gray-900 border border-gray-800 rounded-lg outline-none text-white text-xs font-medium placeholder:text-gray-500"
            />
          )}
        </div>
