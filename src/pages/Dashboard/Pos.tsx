        ...
        <div className="flex gap-2 mb-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl outline-none text-slate-900 dark:text-white text-sm shadow-sm focus:ring-2 focus:ring-emerald-500"
            />
            {searchQuery && (
              <button 
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer ${
                selectedCategory === cat
                  ...
                  : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700'
              }`}
            >
              {cat}
            </button>
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-4 bg-white dark:bg-gray-800 rounded-2xl border transition-all flex flex-col justify-between select-none ${
                      isOut 
                        ? 'opacity-50 border-gray-200 dark:border-gray-700 cursor-not-allowed' 
                        : 'hover:shadow-lg hover:border-emerald-500/50 border-gray-100 dark:border-gray-700/60 cursor-pointer'
                    }`}
                  >
                    <div>
                      {product.image_url && (
        ...
        <div className="p-4 border-b border-gray-100 dark:border-gray-800 space-y-3">
          ...
          {selectedCustomerId === 'balcao' && (
            <input
              ...
              className="w-full px-3 py-1.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg outline-none text-slate-900 dark:text-white text-xs font-medium"
            />
          )}
        </div>
